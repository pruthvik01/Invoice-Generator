                    ...
                    <div class="row" style="margin-bottom: 26px;margin-top: 15px; ">
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <td class="text-left width">Dated<br>'.$detail_row['dated'].'</td>
                            </tr>
                            <tr>
...
<th class="text-left pad">' . $row6['product_name']  . '  '.$row6['product_qty'].'Kg<br/>
'.$row6['product_description'].'
</th>
<td class="text-left pad">3402</td>
<th class="text-center pad">' . $row6['item_qty'] . '</th>
<td class="text-right pad">' . $row6['item_price'] .'</td>
